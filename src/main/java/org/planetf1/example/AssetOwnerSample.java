...
public class AssetOwnerSample {
     ...
     */
    public AssetOwnerSample(String fileName,
                            String serverName,
    ...
    public static void main(String[] args) {
        ...
        try {
            AssetOwnerSample sample = new AssetOwnerSample(fileName, serverName, serverURLRoot, clientUserId);
